            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-base text-gray-700 mb-8">
                  A chair isn&lsquo;t just a piece of furniture it&lsquo;s where
                  life happens. It&lsquo;s where you sip your morning coffee,
                  dive into work, share meals with family, or curl up with a
                  good book. Over time, though, chairs collect more than
                  memories: dust, stains, crumbs, and even hidden allergens
                  settle in where you least expect them.
                  <br />
                  <br />
                  Bright Fibre Chair Cleaning restores more than just fabric it
                  restores comfort. Our professional service goes beyond the
                  surface, targeting the buildup that everyday vacuuming
                  can&lsquo;t reach. Using advanced equipment and eco-friendly
                  products, we revive your chairs, leaving them fresh, hygienic,
                  and looking their best.
                  <br />
                  <br />
                  From dining room chairs to office seating and armchairs, we
                  handle all types of ChairCleaning with care. Whether
                  it&lsquo;s a treasured heirloom, your work-from-home seat, or
                  the chairs your guests notice first, we make sure they stay as
                  inviting as the day you bought them.
                </p>
              </div>
            </div>
            {/* Before/After Slider */}
