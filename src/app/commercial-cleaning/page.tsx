            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-base text-gray-700 mb-8">
                  ...
                  schedule, whether it&lsquo;s daily, weekly, or monthly
                  maintenance. Our services cover offices, retail spaces,
                  hotels, restaurants, schools, healthcare facilities,
                  warehouses, and more. From floors and windows to carpets,
                  upholstery, and high-touch areas, we ensure a healthier,
